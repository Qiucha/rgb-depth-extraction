...
class TestIntegratedStereoDepth(unittest.TestCase):
    def test_integrated_depth_extraction(self):
        ...
        visualizer = StereoRoomVisualizer(stereo_rig=stereo_rig, room=room)
        # Call update to trigger left/right rendering, overlap, and depth map calculation
        visualizer.update()
